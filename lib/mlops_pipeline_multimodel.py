...
def _train_baseline_model(
    ...
    # Get labels
    label_map = {label: idx for idx, label in enumerate(sorted(set(train_df["label"].to_list())))}
...
def build_multimodel_pipeline(
    ...
    # Stage 2: Create k-fold splits (shared)
    ...
    # Stage 3: Generate shared augmentations (shared)
    ...
    # Stage 4: Train all models sequentially
                ...
                for fold_idx, (train_df, val_df) in enumerate(folds):
                    ...
                    try:
                        ...
                        train_loader = DataLoader(
                            ...
                            persistent_workers=model_config.num_workers > 0,
                            prefetch_factor=2 if model_config.num_workers > 0 else None,
                        )
