...
#
# Usage:
#   sbatch src/scripts/slurm_stage5_xgboost_i3d.sh

#SBATCH --job-name=fvc_stage5_xgboost_i3d
...
#SBATCH --output=logs/stage5/xgboost_i3d-%j.out
#SBATCH --error=logs/stage5/xgboost_i3d-%j.err
...
STAGE5_START=$(date +%s)
LOG_FILE="$ORIG_DIR/logs/stage5/xgboost_i3d_${SLURM_JOB_ID:-$$}.log"
