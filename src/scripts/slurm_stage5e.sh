...
#
# Usage:
#   sbatch src/scripts/slurm_stage5_variable_ar_cnn.sh

#SBATCH --job-name=fvc_stage5_variable_ar_cnn
...
#SBATCH --time=8:00:00
#SBATCH --output=logs/stage5/variable_ar_cnn-%j.out
#SBATCH --error=logs/stage5/variable_ar_cnn-%j.err
...
STAGE5_START=$(date +%s)
LOG_FILE="$ORIG_DIR/logs/stage5/variable_ar_cnn_${SLURM_JOB_ID:-$$}.log"
