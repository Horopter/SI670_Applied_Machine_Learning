...
#
# Usage:
#   sbatch src/scripts/slurm_stage5_r2plus1d.sh

#SBATCH --job-name=fvc_stage5_r2plus1d
...
#SBATCH --time=8:00:00
#SBATCH --output=logs/stage5/r2plus1d-%j.out
#SBATCH --error=logs/stage5/r2plus1d-%j.err
...
STAGE5_START=$(date +%s)
LOG_FILE="$ORIG_DIR/logs/stage5/r2plus1d_${SLURM_JOB_ID:-$$}.log"
