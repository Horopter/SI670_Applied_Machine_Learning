#!/bin/bash
#
# SLURM Batch Script for Stage 5: slowfast_multiscale Training
#
# Trains slowfast_multiscale model using scaled videos and extracted features.
#
# Usage:
#   sbatch src/scripts/slurm_stage5_slowfast_multiscale.sh

#SBATCH --job-name=fvc_stage5_slowfast_multiscale
...
#SBATCH --time=8:00:00
#SBATCH --output=logs/stage5/slowfast_multiscale-%j.out
#SBATCH --error=logs/stage5/slowfast_multiscale-%j.err
...
log "=========================================="
log "STAGE 5: slowfast_multiscale MODEL TRAINING JOB"
log "=========================================="
log "Host:        $(hostname)"
log "Date:        $(date -Is)"
...
log "=========================================="
log "Starting Stage 5: slowfast_multiscale Model Training"
log "=========================================="
...
STAGE5_START=$(date +%s)
LOG_FILE="$ORIG_DIR/logs/stage5/slowfast_multiscale_${SLURM_JOB_ID:-$$}.log"
...
log ""
log "============================================================"
log "STAGE 5 (slowfast_multiscale) EXECUTION SUMMARY"
log "============================================================"
