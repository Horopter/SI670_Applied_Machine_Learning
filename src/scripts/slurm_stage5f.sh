#!/bin/bash
#
# SLURM Batch Script for Stage 5: xgboost_pretrained_inception Training
#
# Trains xgboost_pretrained_inception model using scaled videos and extracted features.
#
# Usage:
#   sbatch src/scripts/slurm_stage5_xgboost_pretrained_inception.sh

#SBATCH --job-name=fvc_stage5_xgboost_pretrained_inception
...
#SBATCH --output=logs/stage5/xgboost_pretrained_inception-%j.out
#SBATCH --error=logs/stage5/xgboost_pretrained_inception-%j.err
...
log "=========================================="
log "STAGE 5: xgboost_pretrained_inception MODEL TRAINING JOB"
log "=========================================="
log "Host:        $(hostname)"
log "Date:        $(date -Is)"
...
log "=========================================="
log "Starting Stage 5: xgboost_pretrained_inception Model Training"
log "=========================================="
...
STAGE5_START=$(date +%s)
LOG_FILE="$ORIG_DIR/logs/stage5/xgboost_pretrained_inception_${SLURM_JOB_ID:-$$}.log"
...
log ""
log "============================================================"
log "STAGE 5 (xgboost_pretrained_inception) EXECUTION SUMMARY"
log "============================================================"
