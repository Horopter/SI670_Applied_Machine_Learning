...
SUBSTAGE_SCRIPTS=(
    "src/scripts/slurm_stage1a_augmentation.sh"
    "src/scripts/slurm_stage1b_augmentation.sh"
    "src/scripts/slurm_stage1c_augmentation.sh"
    "src/scripts/slurm_stage1d_augmentation.sh"
)
...
log "  sbatch src/scripts/slurm_stage2_features.sh"
log "=========================================="
