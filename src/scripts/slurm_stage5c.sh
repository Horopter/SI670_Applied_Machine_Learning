...
#SBATCH --job-name=fvc_stage5_naive_cnn
...
#SBATCH --output=logs/stage5/naive_cnn-%j.out
#SBATCH --error=logs/stage5/naive_cnn-%j.err
...
STAGE5_START=$(date +%s)
LOG_FILE="$ORIG_DIR/logs/stage5/naive_cnn_${SLURM_JOB_ID:-$$}.log"
