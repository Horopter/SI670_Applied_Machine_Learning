...
#
# Usage:
#   sbatch src/scripts/slurm_stage5_pretrained_inception.sh

#SBATCH --job-name=fvc_stage5_pretrained_inception
...
#SBATCH --time=8:00:00
#SBATCH --output=logs/stage5/pretrained_inception-%j.out
#SBATCH --error=logs/stage5/pretrained_inception-%j.err
...
STAGE5_START=$(date +%s)
LOG_FILE="$ORIG_DIR/logs/stage5/pretrained_inception_${SLURM_JOB_ID:-$$}.log"
