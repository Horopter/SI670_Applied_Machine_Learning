#!/bin/bash
#
# SLURM Batch Script for Stage 5: vivit Training
#
# Trains vivit model using scaled videos and extracted features.
#
# Usage:
#   sbatch src/scripts/slurm_stage5_vivit.sh

#SBATCH --job-name=fvc_stage5_vivit
...
#SBATCH --time=8:00:00
#SBATCH --output=logs/stage5/vivit-%j.out
#SBATCH --error=logs/stage5/vivit-%j.err
...
log "=========================================="
log "STAGE 5: vivit MODEL TRAINING JOB"
log "=========================================="
log "Host:        $(hostname)"
log "Date:        $(date -Is)"
...
log "=========================================="
log "Starting Stage 5: vivit Model Training"
log "=========================================="
...
STAGE5_START=$(date +%s)
LOG_FILE="$ORIG_DIR/logs/stage5/vivit_${SLURM_JOB_ID:-$$}.log"
...
log ""
log "============================================================"
log "STAGE 5 (vivit) EXECUTION SUMMARY"
log "============================================================"
