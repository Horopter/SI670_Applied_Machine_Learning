...
#SBATCH --job-name=fvc_stage5_svm
...
#SBATCH --output=logs/stage5/svm-%j.out
#SBATCH --error=logs/stage5/svm-%j.err
...
STAGE5_START=$(date +%s)
LOG_FILE="$ORIG_DIR/logs/stage5/svm_${SLURM_JOB_ID:-$$}.log"
