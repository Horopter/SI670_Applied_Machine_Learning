...
#SBATCH --job-name=fvc_stage5_i3d
...
#SBATCH --time=8:00:00
#SBATCH --output=logs/stage5/i3d-%j.out
#SBATCH --error=logs/stage5/i3d-%j.err
...
STAGE5_START=$(date +%s)
LOG_FILE="$ORIG_DIR/logs/stage5/i3d_${SLURM_JOB_ID:-$$}.log"
