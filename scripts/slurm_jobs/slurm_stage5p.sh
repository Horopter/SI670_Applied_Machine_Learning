#!/bin/bash
#
# SLURM Batch Script for Stage 5: r2plus1d Training
#
# Trains r2plus1d model using scaled videos and extracted features.
#
# Usage:
#   sbatch scripts/slurm_jobs/slurm_stage5_r2plus1d.sh

#SBATCH --job-name=fvc_stage5p
...
#SBATCH --error=logs/stage5/stage5p-%j.err
...
log "=========================================="
log "STAGE 5: r2plus1d MODEL TRAINING JOB"
log "=========================================="
log "Host:        $(hostname)"
log "Date:        $(date -Is)"
...
log "=========================================="
log "Starting Stage 5: r2plus1d Model Training"
log "=========================================="
...
STAGE5_START=$(date +%s)
LOG_FILE="$ORIG_DIR/logs/stage5/stage5p_${SLURM_JOB_ID:-$$}.log"
...
log ""
log "============================================================"
log "STAGE 5 (r2plus1d) EXECUTION SUMMARY"
log "============================================================"
