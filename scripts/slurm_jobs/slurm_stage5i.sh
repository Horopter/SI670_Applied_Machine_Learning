#!/bin/bash
#
# SLURM Batch Script for Stage 5: xgboost_vit_gru Training
#
# Trains xgboost_vit_gru model using scaled videos and extracted features.
#
# Usage:
#   sbatch scripts/slurm_jobs/slurm_stage5_xgboost_vit_gru.sh

#SBATCH --job-name=fvc_stage5i
...
#SBATCH --output=logs/stage5/stage5i-%j.out
#SBATCH --error=logs/stage5/stage5i-%j.err
...
log "=========================================="
log "STAGE 5: xgboost_vit_gru MODEL TRAINING JOB"
log "=========================================="
log "Host:        $(hostname)"
log "Date:        $(date -Is)"
...
log "=========================================="
log "Starting Stage 5: xgboost_vit_gru Model Training"
log "=========================================="
...
STAGE5_START=$(date +%s)
LOG_FILE="$ORIG_DIR/logs/stage5/stage5i_${SLURM_JOB_ID:-$$}.log"
...
log ""
log "============================================================"
log "STAGE 5 (xgboost_vit_gru) EXECUTION SUMMARY"
log "============================================================"
