#!/bin/bash
#
# SLURM Batch Script for Stage 5: svm Training
#
# Trains svm model using scaled videos and extracted features.
#
# Usage:
#   sbatch scripts/slurm_jobs/slurm_stage5_svm.sh

#SBATCH --job-name=fvc_stage5b
...
#SBATCH --output=logs/stage5/stage5b-%j.out
#SBATCH --error=logs/stage5/stage5b-%j.err
...
log "=========================================="
log "STAGE 5: svm MODEL TRAINING JOB"
log "=========================================="
log "Host:        $(hostname)"
log "Date:        $(date -Is)"
...
log "=========================================="
log "Starting Stage 5: svm Model Training"
log "=========================================="
...
STAGE5_START=$(date +%s)
LOG_FILE="$ORIG_DIR/logs/stage5/stage5b_${SLURM_JOB_ID:-$$}.log"
...
log ""
log "============================================================"
log "STAGE 5 (svm) EXECUTION SUMMARY"
log "============================================================"
