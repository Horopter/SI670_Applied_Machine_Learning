...
#
# Usage:
#   sbatch scripts/slurm_jobs/slurm_stage5_vivit.sh

#SBATCH --job-name=fvc_stage5n
...
#SBATCH --output=logs/stage5/stage5n-%j.out
...
STAGE5_START=$(date +%s)
LOG_FILE="$ORIG_DIR/logs/stage5/stage5n_${SLURM_JOB_ID:-$$}.log"
