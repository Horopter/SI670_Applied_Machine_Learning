...
#
# Usage:
#   sbatch scripts/slurm_jobs/slurm_stage3b_scaling.sh

#SBATCH --job-name=fvc_stage3b_scaling
...
#SBATCH --time=8:00:00
#SBATCH --output=logs/stage3b_scaling-%j.out
#SBATCH --error=logs/stage3b_scaling-%j.err
...
log "=========================================="
log "STAGE 3b: VIDEO SCALING JOB"
log "=========================================="
log "Host:        $(hostname)"
log "Date:        $(date -Is)"
...
log ""
log "=========================================="
log "STAGE 3b: VIDEO RANGE ASSIGNMENT"
log "=========================================="
...
log "=========================================="
log "Starting Stage 3b: Video Scaling"
...
STAGE3_START=$(date +%s)
LOG_FILE="$ORIG_DIR/logs/stage3b_scaling_${SLURM_JOB_ID:-$$}.log"
...
if "$PYTHON_CMD" "$PYTHON_SCRIPT" \
    ...
    STAGE3_END=$(date +%s)
    STAGE3_DURATION=$((STAGE3_END - STAGE3_START))
    log "✗ ERROR: Stage 3b failed after ${STAGE3_DURATION}s"
...
log ""
log "============================================================"
log "STAGE 3b EXECUTION SUMMARY"
log "============================================================"
