#!/bin/bash
#
# SLURM Batch Script for Stage 5: vit_transformer Training
#
# Trains vit_transformer model using scaled videos and extracted features.
#
# Usage:
#   sbatch scripts/slurm_jobs/slurm_stage5_vit_transformer.sh

#SBATCH --job-name=fvc_stage5l
...
log "=========================================="
log "STAGE 5: vit_transformer MODEL TRAINING JOB"
log "=========================================="
log "Host:        $(hostname)"
log "Date:        $(date -Is)"
...
log "=========================================="
log "Starting Stage 5: vit_transformer Model Training"
log "=========================================="
...
STAGE5_START=$(date +%s)
LOG_FILE="$ORIG_DIR/logs/stage5/stage5l_${SLURM_JOB_ID:-$$}.log"
...
log ""
log "============================================================"
log "STAGE 5 (vit_transformer) EXECUTION SUMMARY"
log "============================================================"
