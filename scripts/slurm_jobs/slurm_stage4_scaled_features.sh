...
SUBSTAGE_SCRIPTS=(
    "scripts/slurm_jobs/slurm_stage4a_scaled_features.sh"
    "scripts/slurm_jobs/slurm_stage4b_scaled_features.sh"
    "scripts/slurm_jobs/slurm_stage4c_scaled_features.sh"
)
...
log "  sbatch scripts/slurm_jobs/slurm_stage5_training.sh"
log "=========================================="
