#!/bin/bash
#
# SLURM Batch Script for Stage 5: slowfast Training
#
# Trains slowfast model using scaled videos and extracted features.
#
# Usage:
#   sbatch scripts/slurm_jobs/slurm_stage5_slowfast.sh

#SBATCH --job-name=fvc_stage5r
...
#SBATCH --output=logs/stage5/stage5r-%j.out
#SBATCH --error=logs/stage5/stage5r-%j.err
...
log "=========================================="
log "STAGE 5: slowfast MODEL TRAINING JOB"
log "=========================================="
log "Host:        $(hostname)"
log "Date:        $(date -Is)"
...
log "=========================================="
log "Starting Stage 5: slowfast Model Training"
log "=========================================="
...
STAGE5_START=$(date +%s)
LOG_FILE="$ORIG_DIR/logs/stage5/stage5r_${SLURM_JOB_ID:-$$}.log"
...
log ""
log "============================================================"
log "STAGE 5 (slowfast) EXECUTION SUMMARY"
log "============================================================"
