...
ALGORITHM_SCRIPTS=(
    "scripts/slurm_jobs/slurm_stage5a.sh"  # logistic_regression
    "scripts/slurm_jobs/slurm_stage5b.sh"  # svm
    "scripts/slurm_jobs/slurm_stage5c.sh"  # naive_cnn
    "scripts/slurm_jobs/slurm_stage5d.sh"  # pretrained_inception
    "scripts/slurm_jobs/slurm_stage5e.sh"  # variable_ar_cnn
    "scripts/slurm_jobs/slurm_stage5f.sh"  # xgboost_pretrained_inception
    "scripts/slurm_jobs/slurm_stage5g.sh"  # xgboost_i3d
    "scripts/slurm_jobs/slurm_stage5h.sh"  # xgboost_r2plus1d
    "scripts/slurm_jobs/slurm_stage5i.sh"  # xgboost_vit_gru
    "scripts/slurm_jobs/slurm_stage5j.sh"  # xgboost_vit_transformer
    "scripts/slurm_jobs/slurm_stage5k.sh"  # vit_gru
    "scripts/slurm_jobs/slurm_stage5l.sh"  # vit_transformer
    "scripts/slurm_jobs/slurm_stage5m.sh"  # timesformer
    "scripts/slurm_jobs/slurm_stage5n.sh"  # vivit
    "scripts/slurm_jobs/slurm_stage5o.sh"  # i3d
    "scripts/slurm_jobs/slurm_stage5p.sh"  # r2plus1d
    "scripts/slurm_jobs/slurm_stage5q.sh"  # x3d
    "scripts/slurm_jobs/slurm_stage5r.sh"  # slowfast
    "scripts/slurm_jobs/slurm_stage5s.sh"  # slowfast_attention
    "scripts/slurm_jobs/slurm_stage5t.sh"  # slowfast_multiscale
    "scripts/slurm_jobs/slurm_stage5u.sh"  # two_stream
)
