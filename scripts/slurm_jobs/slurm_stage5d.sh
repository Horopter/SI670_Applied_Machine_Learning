#!/bin/bash
#
# SLURM Batch Script for Stage 5: pretrained_inception Training
#
# Trains pretrained_inception model using scaled videos and extracted features.
#
# Usage:
#   sbatch scripts/slurm_jobs/slurm_stage5_pretrained_inception.sh

#SBATCH --job-name=fvc_stage5d
...
#SBATCH --output=logs/stage5/stage5d-%j.out
#SBATCH --error=logs/stage5/stage5d-%j.err
...
log "=========================================="
log "STAGE 5: pretrained_inception MODEL TRAINING JOB"
log "=========================================="
log "Host:        $(hostname)"
log "Date:        $(date -Is)"
...
log "=========================================="
log "Starting Stage 5: pretrained_inception Model Training"
log "=========================================="
...
STAGE5_START=$(date +%s)
LOG_FILE="$ORIG_DIR/logs/stage5/stage5d_${SLURM_JOB_ID:-$$}.log"
...
log ""
log "============================================================"
log "STAGE 5 (pretrained_inception) EXECUTION SUMMARY"
log "============================================================"
