...
#   sbatch scripts/slurm_jobs/slurm_stage1c_augmentation.sh
#   
#   # Or override defaults:
#   FVC_NUM_AUGMENTATIONS=10 FVC_DELETE_EXISTING=1 sbatch scripts/slurm_jobs/slurm_stage1c_augmentation.sh
#
