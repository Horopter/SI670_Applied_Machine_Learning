...
SUBSTAGE_SCRIPTS=(
    "scripts/slurm_jobs/slurm_stage3a_scaling.sh"
    "scripts/slurm_jobs/slurm_stage3b_scaling.sh"
    "scripts/slurm_jobs/slurm_stage3c_scaling.sh"
    "scripts/slurm_jobs/slurm_stage3d_scaling.sh"
    "scripts/slurm_jobs/slurm_stage3e_scaling.sh"
    "scripts/slurm_jobs/slurm_stage3f_scaling.sh"
    "scripts/slurm_jobs/slurm_stage3g_scaling.sh"
    "scripts/slurm_jobs/slurm_stage3h_scaling.sh"
)
...
log "  sbatch scripts/slurm_jobs/slurm_stage4_scaled_features.sh"
log "=========================================="
