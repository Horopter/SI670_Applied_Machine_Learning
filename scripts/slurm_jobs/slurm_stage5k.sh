#!/bin/bash
#
# SLURM Batch Script for Stage 5: vit_gru Training
#
# Trains vit_gru model using scaled videos and extracted features.
#
# Usage:
#   sbatch scripts/slurm_jobs/slurm_stage5_vit_gru.sh

#SBATCH --job-name=fvc_stage5k
...
#SBATCH --output=logs/stage5/stage5k-%j.out
...
log "=========================================="
log "STAGE 5: vit_gru MODEL TRAINING JOB"
log "=========================================="
log "Host:        $(hostname)"
log "Date:        $(date -Is)"
...
log "=========================================="
log "Starting Stage 5: vit_gru Model Training"
log "=========================================="
...
STAGE5_START=$(date +%s)
LOG_FILE="$ORIG_DIR/logs/stage5/stage5k_${SLURM_JOB_ID:-$$}.log"
...
log ""
log "============================================================"
log "STAGE 5 (vit_gru) EXECUTION SUMMARY"
log "============================================================"
