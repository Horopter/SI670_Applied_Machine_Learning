...
#
# Usage:
#   sbatch scripts/slurm_jobs/slurm_stage5_slowfast_multiscale.sh

#SBATCH --job-name=fvc_stage5t
...
#SBATCH --output=logs/stage5/stage5t-%j.out
#SBATCH --error=logs/stage5/stage5t-%j.err
...
STAGE5_START=$(date +%s)
LOG_FILE="$ORIG_DIR/logs/stage5/stage5t_${SLURM_JOB_ID:-$$}.log"
