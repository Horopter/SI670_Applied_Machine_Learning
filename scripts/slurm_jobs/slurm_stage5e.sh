#!/bin/bash
#
# SLURM Batch Script for Stage 5: variable_ar_cnn Training
#
# Trains variable_ar_cnn model using scaled videos and extracted features.
#
# Usage:
#   sbatch scripts/slurm_jobs/slurm_stage5_variable_ar_cnn.sh

#SBATCH --job-name=fvc_stage5e
...
#SBATCH --output=logs/stage5/stage5e-%j.out
#SBATCH --error=logs/stage5/stage5e-%j.err
...
log "=========================================="
log "STAGE 5: variable_ar_cnn MODEL TRAINING JOB"
log "=========================================="
log "Host:        $(hostname)"
log "Date:        $(date -Is)"
...
log "=========================================="
log "Starting Stage 5: variable_ar_cnn Model Training"
log "=========================================="
...
STAGE5_START=$(date +%s)
LOG_FILE="$ORIG_DIR/logs/stage5/stage5e_${SLURM_JOB_ID:-$$}.log"
...
log ""
log "============================================================"
log "STAGE 5 (variable_ar_cnn) EXECUTION SUMMARY"
log "============================================================"
