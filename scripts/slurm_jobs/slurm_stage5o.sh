#!/bin/bash
#
# SLURM Batch Script for Stage 5: i3d Training
#
# Trains i3d model using scaled videos and extracted features.
#
# Usage:
#   sbatch scripts/slurm_jobs/slurm_stage5_i3d.sh

#SBATCH --job-name=fvc_stage5o
...
#SBATCH --output=logs/stage5/stage5o-%j.out
#SBATCH --error=logs/stage5/stage5o-%j.err
...
log "=========================================="
log "STAGE 5: i3d MODEL TRAINING JOB"
log "=========================================="
log "Host:        $(hostname)"
log "Date:        $(date -Is)"
...
log "=========================================="
log "Starting Stage 5: i3d Model Training"
log "=========================================="
...
STAGE5_START=$(date +%s)
LOG_FILE="$ORIG_DIR/logs/stage5/stage5o_${SLURM_JOB_ID:-$$}.log"
...
log ""
log "============================================================"
log "STAGE 5 (i3d) EXECUTION SUMMARY"
log "============================================================"
